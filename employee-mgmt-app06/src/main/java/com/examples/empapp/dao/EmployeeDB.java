...
public class EmployeeDB {
	  static Connection conn = null;
		...
		public void addEmployee(Employee_details employee) throws SQLException
	{
	...
	public List<Employee_details> exportEmployees() throws SQLException
	{
		ArrayList<Employee_details> emplist = new ArrayList<Employee_details>();
		 ...
		 ResultSet rs = preparedStmt.executeQuery();
			...
			while (rs.next()) {
				...
				String designation = rs.getString("designation");
				String salary = rs.getString("salary");
				Employee_details newemp = new Employee_details(id,name,designation,salary);
				emplist.add(newemp);
			}
		return emplist;
